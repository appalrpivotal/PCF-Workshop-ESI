...
. If you haven't already, complete the prequisites and environment setup: https://github.com/dbeauregard-pivotal/PCF-Workshop-ESI/blob/master/labs/labaccess.adoc

== Download
. Download the code, binaries and slides: https://workshopmaterial.cfapps.vca.express-scripts.com (ESI network) or https://github.com/dbeauregard-pivotal/PCF-Workshop-ESI (off the ESI network)
