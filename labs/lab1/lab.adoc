...
== Download
. Download the code, binaries and slides: https://github.com/appalrpivotal/PCF-Workshop-Fedex

== Push It!

. Change to the _cf-workshop-demo_ sample application directory:
+
----
$ cd $HOME/cf-workshop-demo
----
+

. The jar is pre-built in the target directory. Alternatively, you can download it from the below link:

+
----
http://artifactory.snbv2.com:8081/artifactory
----
+
